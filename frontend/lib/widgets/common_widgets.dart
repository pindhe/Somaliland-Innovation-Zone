            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(course.title, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: palette.textPrimary), maxLines: 2, overflow: TextOverflow.ellipsis),
                  const SizedBox(height: 6),
                  Text(course.description, style: TextStyle(color: palette.textSecondary, fontSize: 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                  const SizedBox(height: 12),
                  Row(
                    children: [
                      Icon(Icons.schedule_outlined, size: 14, color: palette.textSecondary),
                      const SizedBox(width: 4),
                      Text(course.duration, style: TextStyle(fontSize: 12, color: palette.textSecondary)),
                      const SizedBox(width: 12),
                      Icon(Icons.person_outline, size: 14, color: palette.textSecondary),
                      const SizedBox(width: 4),
                      Expanded(child: Text(course.instructor, style: TextStyle(fontSize: 12, color: palette.textSecondary), overflow: TextOverflow.ellipsis)),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      Icon(Icons.people_outline, size: 14, color: palette.textSecondary),
                      const SizedBox(width: 4),
                      Text('${course.seatsAvailable} seats left', style: TextStyle(fontSize: 12, color: palette.textSecondary)),
                    ],
                  ),
                ],
              ),
